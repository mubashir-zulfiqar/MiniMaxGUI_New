...
import com.example.minimaxgui_new.ai.MiniMax;
import com.example.minimaxgui_new.ai.MiniMaxAlphaBeta;
import com.example.minimaxgui_new.ai.MiniMaxCombined;
import com.example.minimaxgui_new.ai.MiniMaxImproved;
...
public class TicTacToe extends Application {
    ...
    private static com.example.minimaxgui_new.Board board;
    ...
    private MenuBar initialiseMenu() {
        ...
        newGameOption.setOnAction(e -> resetGame());
        return menuBar;
    }
...
//        int[] move = MiniMaxImproved.getBestMove(board);
